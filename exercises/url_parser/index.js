...
const getUrlObject = (urlFormat, urlInstance) => { 
...
const urlFormat = ':apiVersion/:version/api/:collection/:id/';
const urlInstance = '1/6/api/listings/3/bye?sort=desc&limit=10'
